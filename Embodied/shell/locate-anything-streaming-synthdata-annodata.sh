#!/usr/bin/env bash
# LocateAnything full SFT (Magi Attention, Hopper/Blackwell).
#
# Usage:
#   conda activate locateanything
#   bash shell/locate-anything-streaming.sh [NNODES] [OUTPUT_DIR]
# Foreground:
#   TRAIN_BACKGROUND=0 bash shell/locate-anything-streaming.sh
set -euo pipefail
...
cd "$ROOT"
# =============================================================================
# wandb  (same style as pad_detect / sdpa launcher)
# =============================================================================
...
export WANDB_NAME="${WANDB_NAME:-locateanything-3b-full-synthdatav4mixckpt6000-annodata}"
export WANDB_RESUME="${WANDB_RESUME:-allow}"

# =============================================================================
# Paths / model / data
# =============================================================================
MODEL_PATH=${MODEL_PATH:-"/workspace/models/CheckPoints/pad_dimension_and_pad_hole/locateanything-3b-full-synthdata-v4-mix/checkpoint-6000/"}
